...
| `ANTHROPIC_CONCURRENCY` | `3` (test local ; `2` en production, voir [`../decisions-et-limites-connues.md`](../decisions-et-limites-connues.md)) | Nombre max d'appels Anthropic simultanés (sémaphore **à priorité** — voir [`02-service-claude.md`](02-service-claude.md)) — protège contre le rate limit Anthropic et les pics de coût. |
